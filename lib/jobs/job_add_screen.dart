...
class _AddJobScreenState extends State<AddJobScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: Colors.white, title: Text("Add Job")),
      body: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTextField(
                      ...
                      isRequired: true),
                  _buildTextField(
                      jobController.emailController, "Contact Email",
                  ...
                  _buildTextField(jobController.skillsController, "Skills",
                      maxLines: 3),
                  _buildTextField(
                      jobController.preferredQualificationController,
                      "Preferred Qualification",
                      maxLines: 3),
                  _buildTextField(jobController.companyWebsiteController,
                      "Company Website"),
                  TextFormField(
